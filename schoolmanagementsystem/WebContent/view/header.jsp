    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#!registration"><i class="fa fa-circle-o"></i> Student Admission</a></li>
          	...
          	<li class="treeview">
          		...
          		<ul class="treeview-menu">
          			 	<li><a href="#!createsubject"><i class="fa fa-circle-o"></i>Subjects</a></li>
               	 		...
               	 		<li><a href="#!createexam"><i class="fa fa-circle-o"></i>Create Exam</a></li>
          		 </ul>
          	</li>
...
app.config(function($routeProvider) {
    ...
    .when("/registration", {
        templateUrl : "view/student/studentRegistration.jsp"
    })
    ...
    .when("/createexam", {
        templateUrl : "view/academics/exam.jsp"
    })
     .when("/initialdetails", {
